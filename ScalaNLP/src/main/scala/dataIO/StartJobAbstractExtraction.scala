...
object StartJobAbstractExtraction {
  ...
  /**
   * Starts the text abstract extraction and cleaning pipeline.
   */
  def main(args: Array[String]): Unit = {
    ...
    listOfFilesInDirectory.foreach(file => {
      JsonCleaner.extractJsonTextData(file, inputDirectory, outputDirectory, JsonCleaner.keyTextAbstract);
    })
  }
}
