...
- [[3] Methodik und Daten-Exploration](#3-methodik-und-daten-exploration)
  ...
  * [[3.2] Daten Exploration](#32-daten-exploration)
    ...
    + [[3.2.3] Vokabular & Häufige Worte](#323-vokabular--häufige-worte)
    + [[3.2.4] Dokumentähnlichkeit - Embeddings](#324-dokumentähnlichkeit---embeddings)
...
- [[5] Implementation und Durchführung](#5-implementation-und-durchführung)
  * [[5.1] NLP Processing](#51-nlp-processing)
    ...
    + [[5.1.7] Überblick Verwendete Pipelines](#517-überblick-verwendete-pipelines)
    ...
    + [[5.1.9] Ausführung auf Cluster](#519-ausführung-auf-cluster)
  ...
  * [[5.2] Web-Anwendung](#52-web-anwendung)
    ...
    + [[5.2.3] Persistenzschicht](#523-persistenzschicht)
      - [[5.2.3.1] Auswahlkriterien für MongoDB](#5231-auswahlkriterien-für-mongodb)
    ...
    + [[5.2.5] Modell-Klassen (Entitäten)](#525-modell-klassen-entitäten)
